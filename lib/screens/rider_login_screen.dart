...
class _RiderLoginScreenState extends State<RiderLoginScreen> {
  ...
  void _login() async {
    ...
    final error = await _authService.loginRider(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Rider Login', style: AppText.h1),
            const SizedBox(height: AppSpacing.sm),
            Text(
              'Login to accept delivery orders.',
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => Navigator.pushNamed(context, '/rider-register'),
                  child: Text(
                    'Register',
